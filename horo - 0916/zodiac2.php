...
<head>
  ...
  <meta property="og:description"
    content="月星座から、今日の内面や感情に関するメッセージを無料で診断。12星座の月星座ごとに、心の状態や潜在意識にアプローチするヒントが得られます。素の自分を知る占いを毎日チェック！" />
  <meta property="og:url" content="https://evitadesignart.com/horo/zodiac2.php" />
  ...
  <script type="application/ld+json">
{
  ...
  "url": "https://evitadesignart.com/horo/zodiac2.php", 
...
<body>
  ...
  <div id="fv-wrapper" class="fv-wrapper-custom">
    ...
    <div class="badge-container"><span class="badge-type">占星術</span><span class="badge-type">星占い</span><span class="badge-type">月星座</span></div>
  </div>
  <script>
    (function(){
...
<div class="fv-buttons">
  ...
  <p style="text-align:center;">下の月星座ボタンから選んで、<br class="md:hidden">今日の内面メッセージをチェック！<br>
    <a href="https://evitadesignart.com/horo/#horoscope"><button>生年月日から<br class="md:hidden"> 月星座を調べる</button></a>
  </p>
...
<br><a href="https://evitadesignart.com/horo/" style="display: block; width: 100%; text-align: center;"><button style="width: 100%; max-width: 600px;">占い一覧はコチラ</button></a>
  ...
  `;
      // Share
      let snippetText = message.substring(0, 50) + "...";
      snippetText = snippetText.replace(/^【(正位置|逆位置)】\s*/g, '').replace(/^(正位置|逆位置)\s*/g, '');
      const shareText = encodeURIComponent("#" + data.name + " #月星座 #星座占い \n" + snippetText + " | 占いアルカノヴァ");
