...
<head>
  ...
  <meta property="og:url" content="https://evitadesignart.com/zodiac.php" />
  ...
  <script type="application/ld+json">
{
  ...
  "url": "https://evitadesignart.com/zodiac.php",  
...
<div class="fv-buttons">
  ...
  <p style="text-align:center;">下の星座ボタンから選んで<br class="md:hidden">占い結果をチェック！<br>
    <a href="https://evitadesignart.com/tarotte_list.php#horoscope"><button>生年月日から<br class="md:hidden"> 太陽星座を調べる</button></a>
  </p>
