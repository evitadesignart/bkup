...
<head>
  ...
  <title>無料月星座占い｜内面の性格と今日のメッセージをチェック</title>
  ...
  <script type="application/ld+json">
{
  ...
  <style>
    ...
    body {
      ...
      margin: auto;
      margin-top: 5rem;
      background: linear-gradient(135deg, #0b1a3d 0%, #000814 100%);
      color: #e0e7ff;
      min-height: 100vh;
      position: relative;
    }
...
<div class="fv-buttons">
  ...
  <p style="text-align:center;">下の月星座ボタンから選んで、<br class="md:hidden">今日の内面メッセージをチェック！<br>
    <a href="https://evitadesignart.com/tarotte_list.php#horoscope"><button>生年月日から月星座を調べる</button></a>
  </p>
  ...
  <div style="background:#112244;padding:1em;border-radius:8px;margin-bottom:1em;">
    ...
    <ul style="list-style:none; padding:0; margin:0;">
      ...
      <li style="padding-left:1.2em; text-indent:-1.2em;">・ 太陽星座ではピンとこなかった方</li>
  ...
  <p id="overview2">
    ...
    <br><a href="https://evitadesignart.com/tarotte_list.php"><button>占い一覧はコチラ</button></a>
  </p>
