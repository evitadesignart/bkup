...
<head>
  ...
  <title>【無料】12星座占い｜今日の運勢を毎日更新！恋愛・仕事・健康を診断</title>
...
<div class="fv-buttons">
  ...
  <p style="text-align:center;">下の星座ボタンから選んで<br class="md:hidden">占い結果をチェック！<br>
    <a href="https://evitadesignart.com/tarotte_list.php#horoscope"><button>生年月日から太陽星座を調べる</button></a>
  </p>
  ...
  <div style="background:#112244;padding:1em;border-radius:8px;margin-bottom:1em;">
    ...
    <ul style="list-style:none; padding:0; margin:0;">
      ...
      <li style="padding-left:1.2em; text-indent:-1.2em;">・ どの星座占いが自分に合っているか<br class="md:hidden">確かめたい</li>
