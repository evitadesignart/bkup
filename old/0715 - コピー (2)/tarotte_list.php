<?php require_once 'counter.php'; $page_views = get_all_page_views(); ?>
<!DOCTYPE html>
<html lang="ja">
...
<body>
  ...
  <main>
    ...
    <div class="block">
      <a href="https://evitadesignart.com/tarotte7.php" class="img-wrap"><img src="img/t01.jpg" alt="今週の運勢(タロット&星座)"><div class="badge-container"><span class="badge-type">週間</span></div><div class="view-counter"><span class="heart-icon">♥</span> <?php echo isset($page_views['tarotte7']) ? $page_views['tarotte7'] : 0; ?></div></a>
    ...
    <div class="block">
      <a href="https://evitadesignart.com/tarotte5.php" class="img-wrap"><img src="img/t02.jpg" alt="今月の運勢(タロット&星座)"><div class="badge-container"><span class="badge-type">月間</span></div><div class="view-counter"><span class="heart-icon">♥</span> <?php echo isset($page_views['tarotte5']) ? $page_views['tarotte5'] : 0; ?></div></a>
    ...
    <div class="block">
      <a href="https://evitadesignart.com/tarotte6.php" class="img-wrap"><img src="img/t03.jpg" alt="今年の運勢(タロット&星座)"><div class="badge-container"><span class="badge-type">年間</span></div><div class="view-counter"><span class="heart-icon">♥</span> <?php echo isset($page_views['tarotte6']) ? $page_views['tarotte6'] : 0; ?></div></a>
    ...
    <div class="block">
      <a href="https://evitadesignart.com/tarotte2.php" class="img-wrap"><img src="img/t04.jpg" alt="タロット大アルカナ1枚占い"><div class="badge-container"><span class="badge-type">メッセージ</span></div><div class="view-counter"><span class="heart-icon">♥</span> <?php echo isset($page_views['tarotte2']) ? $page_views['tarotte2'] : 0; ?></div></a>
    ...
    <div class="block">
      <a href="https://evitadesignart.com/tarotte4.php" class="img-wrap"><img src="img/t05.jpg" alt="タロット大アルカナ2枚占い"><div class="badge-container"><span class="badge-type">現状</span><span class="badge-type">未来</span></div><div class="view-counter"><span class="heart-icon">♥</span> <?php echo isset($page_views['tarotte4']) ? $page_views['tarotte4'] : 0; ?></div></a>
    ...
    <div class="block">
      <a href="https://evitadesignart.com/tarotte11.php" class="img-wrap"><img src="img/t15.jpg" alt="ターニングポイント占い"><div class="badge-container"><span class="badge-type">岐路</span></div><div class="view-counter"><span class="heart-icon">♥</span> <?php echo isset($page_views['tarotte11']) ? $page_views['tarotte11'] : 0; ?></div></a>
      <a class="button" href="https://evitadesignart.com/tarotte11.php">ターニングポイント占い</a>
      <small>大アルカナであなたの<br> ターニングポイントを占います。</small>
    </div>

    <div class="block">
      <a href="https://evitadesignart.com/tarotte12.php" class="img-wrap"><img src="img/t16.jpg" alt="YES・NO占い"><div class="badge-container"><span class="badge-type">二択</span></div><div class="view-counter"><span class="heart-icon">♥</span> <?php echo isset($page_views['tarotte12']) ? $page_views['tarotte12'] : 0; ?></div></a>
    ...
    <div class="block">
      <a href="https://evitadesignart.com/zodiac.php" class="img-wrap"><img src="img/t10.jpg" alt="星座占い(太陽星座)"><div class="badge-container"><span class="badge-type">太陽星座</span></div><div class="view-counter"><span class="heart-icon">♥</span> <?php echo isset($page_views['zodiac']) ? $page_views['zodiac'] : 0; ?></div></a>
    ...
    <div class="block">
      <a href="https://evitadesignart.com/zodiac2.php" class="img-wrap"><img src="img/t11.jpg" alt="星座占い(月星座)"><div class="badge-container"><span class="badge-type">月星座</span></div><div class="view-counter"><span class="heart-icon">♥</span> <?php echo isset($page_views['zodiac2']) ? $page_views['zodiac2'] : 0; ?></div></a>
    ...
    <div class="block">
      <div class="badge-recommend">おすすめ</div>
      <a href="https://evitadesignart.com/zodiac3.php" class="img-wrap"><img src="img/t12.jpg" alt="星座占い(アセンダント)"><div class="badge-container"><span class="badge-type">アセンダント</span></div><div class="view-counter"><span class="heart-icon">♥</span> <?php echo isset($page_views['zodiac3']) ? $page_views['zodiac3'] : 0; ?></div></a>
    ...
    <div class="block">
      <a href="https://evitadesignart.com/color24.php" class="img-wrap"><img src="img/t13.jpg" alt="24の色占い"><div class="badge-container"><span class="badge-type">色占い</span></div><div class="view-counter"><span class="heart-icon">♥</span> <?php echo isset($page_views['color24']) ? $page_views['color24'] : 0; ?></div></a>
    ...
    <div class="block">
      <a href="https://evitadesignart.com/engel.php" class="img-wrap"><img src="img/t17.jpg" alt="エンジェルナンバーガイド"><div class="badge-container"><span class="badge-type">エンジェルナンバー</span></div><div class="view-counter"><span class="heart-icon">♥</span> <?php echo isset($page_views['engel']) ? $page_views['engel'] : 0; ?></div></a>
