...
<head>
  ...
  <meta property="og:url" content="https://evitadesignart.com/tarotte.php">
  <meta property="og:type" content="website">
  <title>無料3枚引きタロット占い｜過去・現在・未来の運勢診断</title>
  ...
  <script type="application/ld+json">
{
  ...
  "url": "https://evitadesignart.com/tarotte.php",
...
<div class="fv-buttons">
  <a href="https://evitadesignart.com/tarotte_list.php#tarot-menu" class="tarot-btn"><i class="fa-solid fa-moon"></i>タロット一覧</a>
  <a href="https://evitadesignart.com/tarotte_list.php#zodiac-menu" class="tarot-btn"><i class="fa-solid fa-star"></i>占星術</a>
  <a href="https://evitadesignart.com/tarotte_list.php#horoscope" class="tarot-btn"><i class="fa-solid fa-chart-pie"></i>アセンダント<br class="md:hidden">診断</a>
</div>
  ...
  <p id="overview2">過去のカードはこれまでの経験や影響、<br class="md:hidden"> 現在のカードは現状、<br class="md:hidden"> 未来のカードはこれから訪れる<br
