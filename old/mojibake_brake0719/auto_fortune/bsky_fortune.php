...
// ==========================================
$source_file = __DIR__ . '/../tarotte7.php';
...
// カード画像の合成
$card_img_path = realpath(__DIR__ . '/../' . ltrim($card['img'], '/'));
if ($card_img_path && file_exists($card_img_path)) {
    $card_image = imagecreatefromstring(file_get_contents($card_img_path));
    if ($card_image !== false) {
