...
<body>
  ...
  <main>
    ...
    <div class="parallax-bg-section" style="text-align: center; margin: 2rem 0; width: 100vw; margin-left: calc(50% - 50vw); margin-right: calc(50% - 50vw); background-image: url('https://images.unsplash.com/photo-1462331940025-496dfbfc7564?q=80&w=2048&auto=format&fit=crop'); background-size: cover; background-position: center; padding: 4rem 1rem; box-sizing: border-box;">
      ...
      <a href="https://evitadesignart.com/tarotte_list.php" style="font-family: 'Noto Serif JP', 'Yu Mincho', 'YuMincho', serif; font-size: 1.8rem; text-decoration: none; color: #fff; text-shadow: 0 2px 4px rgba(0,0,0,0.8);">占いアルカノヴァ</a>
    </div>
    <hr>
    ...
    <div class="block">
      ...
      <a href="https://evitadesignart.com/tarotte7.php" class="img-wrap"><img src="img/t01.jpg" alt="今週の運勢(タロット&星座)">
    ...
    <div class="block">
      ...
      <a href="https://evitadesignart.com/tarotte5.php" class="img-wrap"><img src="img/t02.jpg" alt="今月の運勢(タロット&星座)">
        <div class="badge-container"><span class="badge-type">占星術</span><span class="badge-type">タロット</span><span
    ...
    <div class="block">
      ...
      <a href="https://evitadesignart.com/tarotte6.php" class="img-wrap"><img src="img/t03.jpg" alt="今年の運勢(タロット&星座)">
        <div class="badge-container"><span class="badge-type">占星術</span><span class="badge-type">タロット</span><span
    ...
    <div class="block">
      ...
      <a href="https://evitadesignart.com/tarotte2.php" class="img-wrap"><img src="img/t04.jpg" alt="タロット大アルカナ1枚占い">
    ...
    <div class="block">
      ...
      <a href="https://evitadesignart.com/tarotte4.php" class="img-wrap"><img src="img/t05.jpg" alt="タロット大アルカナ2枚占い">
    ...
    <div class="block">
      ...
      <a href="https://evitadesignart.com/tarotte.php" class="img-wrap"><img src="img/t06.jpg" alt="タロット大アルカナ3枚占い">
    ...
    <div class="block">
      ...
      <a href="https://evitadesignart.com/tarotte9.php" class="img-wrap"><img src="img/t07.jpg" alt="タロット2枚相手と自分占い">
    ...
    <div class="block">
      ...
      <a href="https://evitadesignart.com/tarotte8.php" class="img-wrap"><img src="img/t08.jpg" alt="タロット3枚恋愛占い">
    ...
    <div class="block">
      ...
      <a href="https://evitadesignart.com/tarotte3.php" class="img-wrap"><img src="img/t09.jpg" alt="タロット小アルカナ占い">
    ...
    <div class="block">
      ...
      <a href="https://evitadesignart.com/tarotte10.php" class="img-wrap"><img src="img/t14.jpg" alt="アルカナ診断">
    ...
    <div class="block">
      ...
      <a href="https://evitadesignart.com/tarotte11.php" class="img-wrap"><img src="img/t15.jpg" alt="ターニングポイント占い">
    ...
    <div class="block">
      ...
      <a href="https://evitadesignart.com/tarotte12.php" class="img-wrap"><img src="img/t16.jpg" alt="YES・NO占い">
    ...
    <div class="block">
      ...
      <a href="https://evitadesignart.com/zodiac.php" class="img-wrap"><img src="img/t10.jpg" alt="星座占い(太陽星座)">
    ...
    <div class="block">
      ...
      <a href="https://evitadesignart.com/zodiac2.php" class="img-wrap"><img src="img/t11.jpg" alt="星座占い(月星座)">
    ...
    <div class="block">
      ...
      <a href="https://evitadesignart.com/zodiac3.php" class="img-wrap"><img src="img/t12.jpg" alt="星座占い(アセンダント)">
    ...
    <div class="block">
      ...
      <a href="https://evitadesignart.com/color24.php" class="img-wrap"><img src="img/t13.jpg" alt="24の色占い">
    ...
    <div class="block">
      ...
      <a href="https://evitadesignart.com/engel.php" class="img-wrap"><img src="img/t17.jpg" alt="エンジェルナンバーガイド">
    ...
    <div class="bsky-feed-container">
      ...
      function get_bsky_posts_api($actor, $limit = 3) {
          $url = "https://public.api.bsky.app/xrpc/app.bsky.feed.getAuthorFeed?actor=" . urlencode($actor) . "&limit=" . $limit;
...
<script>
// SP実機対応：完全固定背景（スクロール相殺アルゴリズム） - tarotte_list.php 専用
document.addEventListener("DOMContentLoaded", function() {
  ...
  function updateParallax() {
    parallaxSections.forEach(section => {
      ...
      if (bgLayer) {
        ...
        // bgLayer の位置を相殺する
        // bgLayer は絶対配置で top:0, left:0 にいる。
        // 親要素が画面の左上 (0,0) からどれだけズレているか (rect.left, rect.top) を取得し、
        // その分だけマイナス方向に移動させれば、bgLayer の左上は常に画面の左上 (0,0) に固定される。
