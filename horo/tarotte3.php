...
track_page_view(basename(__FILE__, '.php')); ?>
<!DOCTYPE html>
<html lang="ja">

<head>
  <meta charset="utf-8">
  <title>大アルカナより詳細に無料で占える！小アルカナ無料タロット占い | 占いアルカノヴァ</title>
  ...
  <meta name="description"
    content="完全無料で楽しめる小アルカナのタロット占い。大アルカナよりもさらに詳細に、あなたの未来や現状、具体的な状況を占います。56枚のカードから今のあなたに必要なメッセージをお届けします。詳細解説付き。">
  
  <meta property="og:image" content="https://evitadesignart.com/horo/img/ogp.jpg">
  <meta property="og:title" content="大アルカナより詳細に無料で占える！小アルカナ無料タロット占い">
  <meta property="og:description" content="完全無料で楽しめる小アルカナのタロット占い。大アルカナよりもさらに詳細に、あなたの未来や現状、具体的な状況を占います。">
  <meta property="og:type" content="website">
  <meta property="og:url" content="https://evitadesignart.com/horo/tarotte3.php">

  <meta name="twitter:card" content="summary">
  <meta name="twitter:title" content="大アルカナより詳細に無料で占える！小アルカナ無料タロット占い">
  <meta name="twitter:description" content="完全無料で楽しめる小アルカナのタロット占い。大アルカナよりもさらに詳細に、あなたの未来や現状、具体的な状況を占います。">

  <link rel="icon" href="https://evitadesignart.com/horo/img/favicon.ico" type="image/x-icon">
  <script type="application/ld+json">
{
  ...
  <style>
    ...
    @keyframes draw-pulse {
      0% {
        transform: scale(1);
        box-shadow: 0 8px 0 #b38b22, 0 15px 15px rgba(212, 175, 55, 0.4), inset 0 2px 2px rgba(255, 255, 255, 0.8);
      }

      50% {
        transform: scale(1.03);
        box-shadow: 0 8px 0 #b38b22, 0 20px 25px rgba(212, 175, 55, 0.9), inset 0 2px 2px rgba(255, 255, 255, 0.8);
        border-color: #fff;
      }
...
<body>
  <header>
    <a href="https://evitadesignart.com/horo/">
      <h1><span style="font-size:1.2rem;">大アルカナより詳細無料！</span><br>小アルカナ無料タロット占い</h1>
    </a>
    <?php include("nav.php"); ?>
  </header>
  <style>
  ...
  <div id="fv-wrapper" class="fv-wrapper-custom">
    ...
    <div class="badge-container"><span class="badge-type">タロット占い</span><span class="badge-type">小アルカナ</span><span
        class="badge-type">詳細</span><span class="badge-type">実務</span><span class="badge-type">感情</span></div>
  </div>
  <script>
    (function () {
  ...
  <div class="fv-buttons">
    <a href="https://evitadesignart.com/horo/#tarot-menu" class="tarot-btn"><i
        class="fa-solid fa-moon"></i>タロット占い<br>一覧</a>
    <a href="https://evitadesignart.com/horo/#zodiac-menu" class="tarot-btn"><i
        class="fa-solid fa-star"></i>星占い<br>一覧</a>
    <a href="https://evitadesignart.com/horo/#horoscope" class="tarot-btn"><i
        class="fa-solid fa-chart-pie"></i>アセンダント<br>診断</a>
  </div>
  <p style="max-width: 720px; margin: 0 auto; font-size: 1rem; color: #e0dede; padding: 0 10px;">
    <strong style="color: #ffd;">完全無料で楽しめる<br class="md:hidden">小アルカナのタロット占い。<br>大アルカナよりもさらに詳細に、<br
        class="md:hidden">あなたの未来や現状、<br class="md:hidden">具体的な状況を占うことができます。</strong><br><br>
  ...
  <p>カードを引いてください。</p>
  <button id="drawBtn"><span style="text-align: center; line-height: 1.2;">運勢を占う<br><span
        style="font-size: 0.8em; font-weight: normal;">（カードを引く）</span></span></button>
  <div id="result"></div>
  ...
  <h2><a href="https://evitadesignart.com/horo/"
      style="display: block; width: 100%; text-align: center;"><button
        style="width: 100%; max-width: 600px;">占い一覧はコチラ</button></a></h2>

  <footer>

    <div class="footer-added-section parallax-bg-section"
      style="background-image: url('https://images.unsplash.com/photo-1462331940025-496dfbfc7564?q=80&w=2048&auto=format&fit=crop'); background-size: cover; background-position: center; color: #fff; padding: 4rem 1rem; margin-bottom: 2rem; width: 100vw; margin-left: calc(50% - 50vw); margin-right: calc(50% - 50vw); box-sizing: border-box;">
      <div class="footer-menu"
        style="text-align: center; max-width: 1000px; margin: 0 auto; padding: 0 1rem; box-sizing: border-box;">
        <div class="footer-link-grid"
          style="display: flex; flex-wrap: wrap; justify-content: center; gap: 15px; line-height: 1.5; font-size: 0.9rem;">
          <a href="https://evitadesignart.com/horo/" title="占い一覧ページ"
            style="text-decoration: none; color: #fff;">TOP</a>
          <a href="https://evitadesignart.com/horo/tarotte7.php" title="タロットと星座で今週の運勢"
            style="text-decoration: none; color: #fff;">今週の運勢(タロット&amp;星座)</a>
          <a href="https://evitadesignart.com/horo/tarotte5.php" title="タロットと星座で今月の運勢"
            style="text-decoration: none; color: #fff;">今月の運勢(タロット&amp;星座)</a>
          <a href="https://evitadesignart.com/horo/tarotte6.php" title="タロットと星座で今年の運勢"
            style="text-decoration: none; color: #fff;">今年の運勢(タロット&amp;星座)</a>
          <a href="https://evitadesignart.com/horo/tarotte2.php" title="大アルカナ1枚占い"
            style="text-decoration: none; color: #fff;">タロット大アルカナ1枚占い</a>
          <a href="https://evitadesignart.com/horo/tarotte4.php" title="大アルカナ2枚占い"
            style="text-decoration: none; color: #fff;">タロット大アルカナ2枚占い</a>
          <a href="https://evitadesignart.com/horo/tarotte.php" title="大アルカナ3枚占い"
            style="text-decoration: none; color: #fff;">タロット大アルカナ3枚占い</a>
          <a href="https://evitadesignart.com/horo/tarotte9.php" title="相手と自分の2枚占い"
            style="text-decoration: none; color: #fff;">タロット2枚相手と自分占い</a>
          <a href="https://evitadesignart.com/horo/tarotte8.php" title="恋愛に特化した3枚占い"
            style="text-decoration: none; color: #fff;">タロット3枚恋愛占い</a>
          <a href="https://evitadesignart.com/horo/tarotte3.php" title="小アルカナ占い"
            style="text-decoration: none; color: #fff;">タロット小アルカナ占い</a>
          <a href="https://evitadesignart.com/horo/tarotte10.php" title="アルカナ診断"
            style="text-decoration: none; color: #fff;">あなたのアルカナ診断</a>
          <a href="https://evitadesignart.com/horo/tarotte11.php" title="ターニングポイント占い"
            style="text-decoration: none; color: #fff;">ターニングポイント占い</a>
          <a href="https://evitadesignart.com/horo/tarotte12.php" title="YESNOワンカード占い"
            style="text-decoration: none; color: #fff;">YES・NOワンカード占い</a>
          <a href="https://evitadesignart.com/horo/zodiac.php" title="太陽星座の占い"
            style="text-decoration: none; color: #fff;">星座占い(太陽星座)</a>
          <a href="https://evitadesignart.com/horo/zodiac2.php" title="月星座の占い"
            style="text-decoration: none; color: #fff;">星座占い(月星座)</a>
          <a href="https://evitadesignart.com/horo/zodiac3.php" title="アセンダントの星座占い"
            style="text-decoration: none; color: #fff;">星座占い(アセンダント)</a>
          <a href="https://evitadesignart.com/horo/color24.php" title="24色から占う性格診断"
            style="text-decoration: none; color: #fff;">24の色占い</a>
          <a href="https://evitadesignart.com/horo/engel.php" title="エンジェルナンバーガイド"
            style="text-decoration: none; color: #fff;">エンジェルナンバーガイド</a>
        </div>
      </div>
    </div>
    <div class="footer-brand" style="text-align: center; margin-bottom: 2rem;">
      <a href="https://evitadesignart.com/horo/"
        style="font-family: 'Noto Serif JP', 'Yu Mincho', 'YuMincho', serif; font-size: 1.5rem; text-decoration: none; color: inherit;">占いアルカノヴァ</a><br>
      <small style="display: block; margin-top: 0.5rem; font-size: 0.8rem; color: #ccc;">運営 <a
          href="https://evitadesignart.com/" style="text-decoration: none; color: inherit;">EvitaDesignart</a></small>
    </div>
  ...
  <script>
    ...
    document.getElementById("drawBtn").addEventListener("click", () => {
      ...
      // Determine what variable holds the card name and position.
      // Often it's 'card.name' and 'isUpright'.
      // If we are inside the click handler, we might have access to these.
      // To be safe, we can try to extract the text from the result container if possible, 
      // but since we are generating HTML, we can just use the variables if they exist in scope.
      let shareText = '';
      try {
        let titleText = '';
        let snippetText = '';
        if (typeof card !== 'undefined' && typeof isUpright !== 'undefined') {
            titleText = card.name + '【' + (isUpright ? "正位置" : "逆位置") + '】';
            let desc = isUpright ? card.upright : card.reversed;
            if(!desc) desc = isUpright ? card.description : card.reversed;
            snippetText = (desc || "").replace(/<[^>]*>/g, '').substring(0, 50) + '...';
        } else {
            titleText = document.title.split('|')[0].trim();
            // try to grab text from resultDiv
      ...
      let hashTitle = titleText.replace(/【(正位置|逆位置)】/, ' #$1').replace(/^/, '#');
      shareText = encodeURIComponent(hashTitle + " #タロット占い \n" + snippetText + " | 占いアルカノヴァ");
      } catch(e) {
        shareText = encodeURIComponent(document.title.split('|')[0].trim() + " | 占いアルカノヴァ");
      }

              if (typeof card !== 'undefined' && typeof isUpright !== 'undefined') { fetch('log_tarot.php', {method: 'POST', headers: {'Content-Type': 'application/json'}, body: JSON.stringify({card_name: card.name.replace(/（.*$/, ''), position: isUpright ? '正位置' : '逆位置'})}); }
      const shareHtml = `
  ...
  <div class="fixed-sns-share">
    ...
    <a href="https://www.facebook.com/sharer/sharer.php?u=https://evitadesignart.com/horo/<?php echo basename($_SERVER['PHP_SELF']); ?>"
